...
export default {
  ...
  methods: {
    ...mapActions({
      open: 'users/initAcsUserEdit',
      updateAcsUserAccount: 'users/updateAcsUserAccount',
      updateAcsUserInformation: 'users/updateAcsUserInformation'
    }),
    submitAccount(data) {
      this.updateAcsUserAccount(data)
    },
    submitInformation(data) {
      this.updateAcsUserInformation(data)
    }
  }
}
</script>
